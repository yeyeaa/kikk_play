...
package com.ye.player.widget.wheelwidget;
...
import com.ye.player.widget.wheelwidget.adapter.WheelViewAdapter;
...
public class WheelView extends View {
	...
	/**
	 * return view at special position
	 *
	 * @param tag
	 * @return
	 */
	public View getViewByTag(Object tag) {
		return itemsLayout.findViewWithTag(tag);
	}
	...
	private void initResourcesIfNecessary() {
		if (centerDrawable == null) {
			centerDrawable = ContextCompat.getDrawable(getContext(), R.color.color_gradiant);
		}
	...
	private int calculateLayoutWidth(int widthSize, int mode) {
		...
		itemsLayout.measure(MeasureSpec.makeMeasureSpec(widthSize, MeasureSpec.EXACTLY),
